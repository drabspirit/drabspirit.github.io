...
const Logo = () => (
  <div className="fixed inset-0 flex items-center justify-center pointer-events-none">
    ...
    <span className="text-3xl sm:text-4xl md:text-5xl font-share-tech ml-4">TORBOX</span>
  </div>
);
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between h-20 items-center">
          <div className="flex-1 flex justify-center">
            <Link href="/" className="flex items-center" aria-label="TorBox Home">
              <Logo />
            </Link>
          </div>
          ...
          <div className="hidden md:flex items-center space-x-8">
            ...
            <Link href="https://torbox.app/login" 
      ...
      {isMenuOpen && (
        <div className="md:hidden">
          <div className="px-2 pt-2 pb-3 space-y-1 bg-gray-900 border-b border-gray-800">
            ...
            <Link href="https://torbox.app/pricing" 
               className="block px-3 py-2 text-gray-300 hover:text-white hover:bg-gray-800 rounded-lg transition">
              Pricing
            </Link>
            <Link href="https://torbox.app/login" 
